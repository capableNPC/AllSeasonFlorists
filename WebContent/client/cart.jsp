...
<%@ page import="priv.github.ljjdgh.AllSeasonFlorists.domain.User"%>
									...
									<tr>
										<td>
											...
											<div style="text-align:right; margin-top:10px">
											    <!--继续购物 -->
												<a href="${pageContext.request.contextPath}/showProductByPage?category=/u5168/u90e8/u5546/u54c1">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
                                                 <!--结账 -->
													...
													| <a href="${pageContext.request.contextPath}/client/login.jsp">
														<img src="${pageContext.request.contextPath}/client/images/gwc_buy.gif" border="0" /></a>
													<% 	
													}else{
													%>
