...
import priv.github.ljjdgh.AllSeasonFlorists.dao.UserDao;
import priv.github.ljjdgh.AllSeasonFlorists.domain.User;
import priv.github.ljjdgh.AllSeasonFlorists.exception.ActiveUserException;
import priv.github.ljjdgh.AllSeasonFlorists.exception.RegisterException;
import priv.github.ljjdgh.AllSeasonFlorists.utils.MailUtils;
...
public class UserService {
	...
	public void register(User user) throws RegisterException {
		...
		try {
			dao.addUser(user);
			// 发送激活邮件
			String emailMsg = "感谢您注册四季花店，点击"
					+ "<a href='http://localhost:8080/AllSeasonFlorists/activeUser?activeCode="
