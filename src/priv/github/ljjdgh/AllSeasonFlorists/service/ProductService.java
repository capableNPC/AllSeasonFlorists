package priv.github.ljjdgh.AllSeasonFlorists.service;

import java.sql.SQLException;
import java.util.List;
import priv.github.ljjdgh.AllSeasonFlorists.dao.ProductDao;
import priv.github.ljjdgh.AllSeasonFlorists.domain.PageBean;
import priv.github.ljjdgh.AllSeasonFlorists.domain.Product;
import priv.github.ljjdgh.AllSeasonFlorists.exception.AddProductException;
import priv.github.ljjdgh.AllSeasonFlorists.exception.FindProductByIdException;
import priv.github.ljjdgh.AllSeasonFlorists.exception.ListProductException;
public class ProductService {
	...
	public PageBean findBookByName(int currentPage, int currentCount,
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("前台搜索框根据书名查询商品失败！");
		}
	}
	//后台系统，根据id删除商品信息
